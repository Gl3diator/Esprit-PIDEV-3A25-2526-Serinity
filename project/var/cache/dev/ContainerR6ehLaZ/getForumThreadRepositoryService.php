 ...
 */
class getForumThreadRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ForumThreadRepository' shared autowired service.
     *
     * @return \App\Repository\ForumThreadRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ForumThreadRepository.php';

        return $container->privates['App\\Repository\\ForumThreadRepository'] = new \App\Repository\ForumThreadRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
