 ...
 */
class getPostInteractionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PostInteractionRepository' shared autowired service.
     *
     * @return \App\Repository\PostInteractionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PostInteractionRepository.php';

        return $container->privates['App\\Repository\\PostInteractionRepository'] = new \App\Repository\PostInteractionRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
