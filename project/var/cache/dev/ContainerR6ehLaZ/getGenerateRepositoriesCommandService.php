...
class getGenerateRepositoriesCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['App\\Command\\GenerateRepositoriesCommand'] = $instance = new \App\Command\GenerateRepositoriesCommand(($container->privates['filesystem'] ??= new \Symfony\Component\Filesystem\Filesystem()), \dirname(__DIR__, 4));

        $instance->setName('app:generate:repositories');
        $instance->setDescription('Generate Doctrine repositories for entities in src/Entity.');
