...
joblib.dump(clf,      "ml_models/sleep_quality_model.pkl")
joblib.dump(reg,      "ml_models/wake_time_model.pkl")
joblib.dump(scaler,   "ml_models/scaler.pkl")
joblib.dump(le_noise, "ml_models/encoder_noise.pkl")
joblib.dump(le_mood,  "ml_models/encoder_mood.pkl")
joblib.dump(le_bmi,   "ml_models/encoder_bmi.pkl")
