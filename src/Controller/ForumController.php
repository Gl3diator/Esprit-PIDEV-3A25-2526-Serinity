...
class ForumController extends AbstractController
{
    ...
    public function feed(Request $request, ThreadService $threadService, CategoryRepository $categoryRepository, CurrentUserService $currentUserService, ProfileLookupService $profileLookupService): Response
    {
    ...
    public function myThreads(CurrentUserService $currentUserService, ThreadService $threadService, CategoryRepository $categoryRepository, Request $request, ProfileLookupService $profileLookupService): Response
    {
        $currentUser = $currentUserService->requireUser();
        if ($currentUserService->isAdmin($currentUser)) {
            return $this->redirectToRoute('app_admin_forum');
    ...
    public function followed(CurrentUserService $currentUserService, PostInteractionRepository $interactionRepository, CategoryRepository $categoryRepository, Request $request, ProfileLookupService $profileLookupService): Response
    {
        $currentUser = $currentUserService->requireUser();
        if ($currentUserService->isAdmin($currentUser)) {
            return $this->redirectToRoute('app_admin_forum');
    ...
    public function archived(ForumThreadRepository $threadRepository, CurrentUserService $currentUserService, CategoryRepository $categoryRepository, Request $request, ProfileLookupService $profileLookupService): Response
    {
        $currentUser = $currentUserService->requireUser();
        if ($currentUserService->isAdmin($currentUser)) {
            return $this->redirectToRoute('app_admin_forum');
    ...
    public function editReply(Reply $reply, Request $request, CurrentUserService $currentUserService, ReplyService $replyService): Response
    {
        $currentUser = $currentUserService->requireUser();
        if ($currentUserService->isAdmin($currentUser)) {
            return $this->redirectToRoute('app_admin_forum');
    ...
    public function deleteReply(Reply $reply, Request $request, CurrentUserService $currentUserService, ReplyService $replyService): Response
    {
        $currentUser = $currentUserService->requireUser();
        if ($currentUserService->isAdmin($currentUser)) {
            return $this->redirectToRoute('app_admin_forum');
