...
namespace App\Controller\Access\User\Api;

use App\Controller\Access\Api\AbstractApiController;
...
final class UserDashboardController extends AbstractApiController
{
    ...
    #[Route('/{module}', name: 'module_placeholder', methods: ['GET'], requirements: ['module' => 'consultations|exercises|forum|mood|sleep'])]
