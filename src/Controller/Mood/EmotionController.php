...
use App\Entity\Mood\Emotion;
use App\Form\Mood\EmotionType;
...
final class EmotionController extends AbstractController
{
    ...
    public function index(EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('mood/admin/emotion/index.html.twig', [
            'emotions' => $emotions,
        ]);
    }
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('mood/admin/emotion/new.html.twig', [
            'emotion' => $emotion,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('mood/admin/emotion/show.html.twig', [
            'emotion' => $emotion,
        ]);
    }
    ...
    public function edit(Request $request, Emotion $emotion, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('mood/admin/emotion/edit.html.twig', [
            'emotion' => $emotion,
            'form' => $form,
        ]);
    }
