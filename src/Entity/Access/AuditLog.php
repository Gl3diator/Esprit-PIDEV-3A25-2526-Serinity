...
class AuditLog
{
    ...
    private AuthSession $authSession; // ✅ même namespace, pas besoin d'import
    ...
    public function getPrivateIpAddress(): string { return $this->privateIpAddress; }
    public function setPrivateIpAddress(string $privateIpAddress): self { $this->privateIpAddress = $privateIpAddress; return $this; }

    public function getMacAddress(): ?string { return $this->macAddress; }
    public function setMacAddress(?string $macAddress): self { $this->macAddress = $macAddress; return $this; }
    ...
    public function getAuthSession(): AuthSession { return $this->authSession; }
    public function setAuthSession(AuthSession $authSession): self { $this->authSession = $authSession; return $this; }
}