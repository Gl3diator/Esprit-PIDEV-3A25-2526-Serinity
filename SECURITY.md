...
# Security Policy for serinity-web

## Supported Versions

The serinity-web project provides security updates for the following versions:
...
We appreciate the security community's efforts in helping us maintain serinity-web’s safety and integrity.

## Security Practices

serinity-web follows industry best practices for security to ensure safe transactions and protect user data:

### 1. **Authentication and Authorization**

- serinity-web uses secure methods for user authentication, including strong password hashing (e.g., bcrypt).
...
Contributors can help enhance serinity-web's security by following these practices:
...
Thank you for helping us make serinity-web secure for our users and the community!
